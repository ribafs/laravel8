            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-title">
                        <h2 class="text-center">{{ __('CRUD de Artigos - DataTables') }}</h2>
...
## Criar um factory para inserir 1000 articles
```php
<?php
...
App\Models\Article::factory()->count(1000)->create();
